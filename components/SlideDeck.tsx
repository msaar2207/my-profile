...
const slides: Slide[] = [
  {
    ...
    bullets: [
      "9+ years building production systems across AI, finance, HRMS & IoT",
      "Expert in AI orchestration, RAG, multi-model workflows & cloud architectures",
      "Hands-on with LangChain, LLM APIs, vector DBs, and DevOps (AWS/GCP)",
    ],
    note: "Quickly set the frame: who you are, your scope, and where AI + systems work overlap.",
    visual: {
      title: "Career Timeline",
      description: "Highlights across AI orchestration, cloud, and vertical products.",
  ...
  },
  {
    ...
    note: "Explicitly connect this to their DeepSeek/OpenAI orchestration requirements.",
    visual: {
      title: "Routing Flow",
      description: "Decision layer chooses DeepSeek/OpenAI models with fallbacks and SSE.",
  ...
  },
  {
    id: "financial-ml",
    label: "03",
    title: "Financial ML & Sentiment Pipelines",
    subtitle: "LSTM • SVM • Random Forest • Tweet Sentiment",
    bullets: [
      "End-to-end pipeline for stock-trend prediction with LSTM, SVM & Random Forest",
      "Ingested historical stock data + tweet sentiment (FinBERT / custom preprocessing)",
      "Compared models, tracked performance & integrated with real-time data feeds",
    ],
    note: "Use this slide to prove you understand financial data, model mixing, and data recency.",
    visual: {
      title: "Signal Pipeline",
      description: "Market + social data → sentiment → feature store → ensemble outputs.",
      image: "/diagrams/financial-pipeline.svg",
    },
  },
  {
    id: "rag",
    ...
    note: "Connect this directly to migrating 50+ page model docs to cloud + enabling search.",
    visual: {
      title: "RAG Loop",
      description: "Document ingestion, embeddings, vector search, and answer synthesis.",
  ...
  },
  {
    ...
    note: "Reinforce that you’ve run real systems, not just notebooks or demos.",
    visual: {
      title: "Deployment Topology",
      description: "Load balancer → containers → observability and CI/CD gates.",
  ...
  },
  {
    ...
    visual: {
      title: "HRMS Modules",
      description: "Tenant-aware services with AI agents for onboarding and documents.",
  ...
  },
  {
    ...
    note: "This is your ‘production scars’ slide – complexity, reliability, cross-system orchestration.",
    visual: {
      title: "IoT Control Loop",
      description: "Edge device streams + commands with cloud workflows and alerts.",
  ...
  },
  {
    ...
    visual: {
      ...
      description: "Map capabilities to orchestration, RAG, cost control, and reliability.",
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  {isIntro && (
                    <div className="ml-4 h-16 w-16 sm:h-20 sm:w-20 rounded-2xl overflow-hidden border border-slate-700 shadow-lg shadow-purple-900/30 ring-2 ring-purple-500/30">
                      <img
                        src="/profile.jpg"
